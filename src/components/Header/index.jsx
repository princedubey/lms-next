...
import { useUserLogoutMutation } from "../../lib/services/auth";
...
const Header = () => {
  ...
  useEffect(() => {
    ...
    setIsAuth(isAuthenticated || null);
  })
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener("scroll", handleStickyNavbar); // Cleanup
  }, []);
